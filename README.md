...
- Agentic AI
- Prompt Engineering
- Machine Learning pipelines and optimization  
...
### MedShield AI  
AI-based cybersecurity system for medical IoT devices  
- Built anomaly detection models for identifying suspicious activity  
- Implemented preprocessing techniques including SMOTE for class imbalance  
- Applied feature selection methods to improve model performance
...
"Focused on building AI solutions that are practical, efficient, and impactful."
